    ...
    <div className="settings-privacy">
      ...
      <div className="settings-column-content">
        <AllowableRequestType
          ...
          description={<T id="settings.privacy.networkStatus.description" m="General network information (block height, etc) from commanderu.org" />}
        ...
        <AllowableRequestType
          ...
          description={<T id="settings.privacy.stakepoolListing.description" m="List of currently available stakepools from commanderu.org" />}
