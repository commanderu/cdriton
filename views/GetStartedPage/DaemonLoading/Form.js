import { LinearProgressFull, commanderuLoading } from "indicators";
    ...
    <div className="getstarted loader">
      <Aux>
        <div className="content-title">
          <div className="loader-settings-logs">
            {updateAvailable &&
              <Tooltip text={<T id="getStarted.updateAvailableTooltip" m="New version {version} available" values={{ version: (updateAvailable) }}/>}>
                <InvisibleButton className="update-available-button" onClick={() => shell.openExternal("https://commanderu.org/downloads")}>
          ...
          <T id="loader.title" m={"Welcome to commanderuiton Wallet"}/>
        </div>
        ...
        <div className="loader-bar-icon">
          ...
          <commanderuLoading hidden={startupError || isInputRequest} />
        </div>
