  ...
  <div className="page-body getstarted">
    <div className="getstarted loader logs">
      <div className="content-title">
        ...
        <T id="getStarted.logsTitle" m="commanderuiton v{version} Released" values={{ version: (appVersion) }}/>
      </div>
      <div className="release-notes">
        <div className="release-notes-text">
          <p>
          This release of commanderuiton adds some major changes to the wallet startup,
