  ...
  <StandalonePageBody>
    <div className="invalid-rpc-info">
      <T
        ...
        m={`The API of the currently running wallet ({walletRPCVersion}) is not compatible with commanderuiton (required version {requiredWalletRPCVersion}).

        Please update the daemon (cdr) and wallet (cdrwallet) to the latest version, then try again.
