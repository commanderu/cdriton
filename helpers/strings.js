...
// restrictToStdDecimalNumber) into a commanderu atom amount. This performs a
...
//
// Due to floating point inacuracies, a rounding function compatible to cdrutil
// `round` is used (see:
// https://github.com/commanderu/cdr/blob/v1.1.2/cdrutil/amount.go#L77)
//
...
//
// This is fine for representing numbers within the range of the total commanderu
// supply (up to 21e14) but may not be arbitrarily applicable.
export function strTocdrAtoms(s, unitDivisor) {
